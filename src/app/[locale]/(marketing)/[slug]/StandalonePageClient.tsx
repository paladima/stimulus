...
import type { StandalonePageData, StandalonePageSection } from "@/data/standalonePages.en";

interface Props {
  page: StandalonePageData;
  locale: string;
}

function SectionBlock({ section, index }: { section: StandalonePageSection; index: number }) {
...
export default function StandalonePageClient({ page, locale }: Props) {
  const t = useTranslations("common");
  const showCalculator = page.slug === "calculator";
  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container">
        ...
        {/* Calculator widget (only on /calculator) */}
        {showCalculator && (
          <div className="max-w-4xl mx-auto mb-16">
            <ROICalculator />
          </div>
